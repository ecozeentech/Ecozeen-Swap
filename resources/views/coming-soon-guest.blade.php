<x-guest-layout>
    <div class="flex flex-col items-center justify-center text-center py-6">
        ...
        <h2 class="text-xl font-bold text-charcoal-900 dark:text-white">{{ $feature }} — Coming Soon</h2>
        <p class="mt-3 text-sm text-charcoal-500 dark:text-charcoal-400">{{ $message }}</p>
        <a href="{{ route('login') }}" class="mt-6 inline-flex items-center px-5 py-2.5 rounded-lg bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold">Back to Login</a>
    </div>
</x-guest-layout>
